...
def test_foundation_files_are_present() -> None:
    required = {
        ...
        "artifacts/samples/phase_6_optimization_summaries.json",
        ...
        "src/steelflow/optimization/contracts.py",
        "src/steelflow/optimization/envelope.py",
        "src/steelflow/optimization/pipeline.py",
        "src/steelflow/optimization/predictor.py",
        "src/steelflow/optimization/problem.py",
        ...
        "src/steelflow/validation/optimization.py",
