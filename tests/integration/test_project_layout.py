...
def test_foundation_files_are_present() -> None:
    required = {
        ...
        "docs/images/phase7/executive-overview.png",
        "docs/images/phase7/root-cause-explainability.png",
        "docs/images/phase7/forecast-risk.png",
        "docs/images/phase7/scenario-lab.png",
        "docs/images/phase7/model-reliability.png",
        ...
        "artifacts/samples/phase_7_product_summary.json",
        "app/Home.py",
        "app/pages/1_Root_Cause_Explainability.py",
        "app/pages/2_Forecast_Risk.py",
        "app/pages/3_Scenario_Lab.py",
        "app/pages/4_Model_Reliability.py",
        "powerbi/POWER_QUERY.md",
        "powerbi/RELATIONSHIPS.md",
        "powerbi/WIREFRAME.md",
        "powerbi/PACKAGE_CHECKLIST.md",
        "powerbi/load_export_csv.pq",
        "powerbi/measures/steelflow_measures.dax",
        "powerbi/theme/steelflow-industrial.json",
        "scripts/capture_phase7_screenshots.ps1",
        ...
        "src/steelflow/product/artifacts.py",
        "src/steelflow/product/powerbi.py",
        "src/steelflow/product/repository.py",
        "src/steelflow/product/scenario.py",
        "src/steelflow/product/ui.py",
