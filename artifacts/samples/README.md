...
Estes arquivos resumem execuções reais das Fases 2–5 sem versionar Parquet, causal truth, bancos DuckDB, modelos binários ou manifests completos com centenas de arquivos.
