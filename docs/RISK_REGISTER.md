...
| R-009 | Linguagem de portfólio sugerir resultado real ou causalidade. | Média | Alto | Avisos persistentes, contrato de claims e auditoria automática de termos/números em todas as peças publicáveis. | Mitigado na Fase 8; revisão humana ainda necessária antes de publicar |
