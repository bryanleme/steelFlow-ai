...
.PHONY: setup validate-config doctor generate-dev validate-data build-db diagnose build-features train evaluate optimize-demo audit-portfolio test lint app
